...
<section class="relative py-20 md:py-32 overflow-hidden border-t border-slate-100 dark:border-slate-900">
      ...
      {#each services as service (service.title)}
        <div class="flex flex-col">
          <h2 class="text-3xl md:text-4xl font-extrabold tracking-tight text-slate-900 dark:text-white mb-4">
            {service.title} <br />
            <span class="text-slate-500 dark:text-slate-400 text-2xl md:text-3xl">
              {service.highlight}
            </span>
          </h2>
